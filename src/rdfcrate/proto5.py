...
from rdfcrate.rdftype import PropertyList, RdfClass
...
type input = Annotated[
    FormalParameter, RdfTerm("input", "https://bioschemas.org/properties/input")
]
type output = Annotated[
    FormalParameter, RdfTerm("output", "https://bioschemas.org/properties/input")
]
...
x = ComputationalWorkflow(
    graph,
    URIRef("#foo"),
    objects=Bioschemas(input=[FormalParameter(graph, URIRef("#bar"))]),
)
