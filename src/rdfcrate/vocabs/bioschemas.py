...
class associatedDisease(RdfProperty[schemaorg.PropertyValue | schemaorg.MedicalCondition | schemaorg.URL]):
...
class expressedIn(RdfProperty[schemaorg.AnatomicalSystem | schemaorg.BioChemEntity | schemaorg.AnatomicalStructure | schemaorg.DefinedTerm]):
...
class taxonomicRange(RdfProperty[schemaorg.URL | schemaorg.PropertyValue | schemaorg.DefinedTerm | bioschemas.Taxon]):
...
class scientificName(RdfProperty[schemaorg.URL | schemaorg.Text | bioschemas.TaxonName]):
...
class itemLocation(RdfProperty[schemaorg.Place | schemaorg.Text | schemaorg.PostalAddress]):
