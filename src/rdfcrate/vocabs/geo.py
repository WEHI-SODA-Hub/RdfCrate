...
class SpatialObjectCollection(rdfs.Container):
    term = RdfTerm('SpatialObjectCollection', 'http://www.opengis.net/ont/geosparql#SpatialObjectCollection', [])

class SpatialObject(RdfClass):
    term = RdfTerm('SpatialObject', 'http://www.opengis.net/ont/geosparql#SpatialObject', [])

class FeatureCollection(SpatialObjectCollection):
    term = RdfTerm('FeatureCollection', 'http://www.opengis.net/ont/geosparql#FeatureCollection', [])

class GeometryCollection(SpatialObjectCollection):
    term = RdfTerm('GeometryCollection', 'http://www.opengis.net/ont/geosparql#GeometryCollection', [])
...
class defaultGeometry(RdfProperty):
    term = RdfTerm('defaultGeometry', 'http://www.opengis.net/ont/geosparql#defaultGeometry', [])
    object: geo.Geometry

@dataclass(frozen=True)
class hasDefaultGeometry(RdfProperty):
    term = RdfTerm('hasDefaultGeometry', 'http://www.opengis.net/ont/geosparql#hasDefaultGeometry', [])
    object: geo.Geometry
...
class ehCoveredBy(RdfProperty):
    term = RdfTerm('ehCoveredBy', 'http://www.opengis.net/ont/geosparql#ehCoveredBy', [])
    object: geo.SpatialObject
...
class hasGeometry(RdfProperty):
    term = RdfTerm('hasGeometry', 'http://www.opengis.net/ont/geosparql#hasGeometry', [])
    object: geo.Geometry

@dataclass(frozen=True)
class hasBoundingBox(RdfProperty):
    term = RdfTerm('hasBoundingBox', 'http://www.opengis.net/ont/geosparql#hasBoundingBox', [])
    object: geo.Geometry

@dataclass(frozen=True)
class hasCentroid(RdfProperty):
    term = RdfTerm('hasCentroid', 'http://www.opengis.net/ont/geosparql#hasCentroid', [])
    object: geo.Geometry
...
class hasPerimeterLength(RdfProperty):
    term = RdfTerm('hasPerimeterLength', 'http://www.opengis.net/ont/geosparql#hasPerimeterLength', [])
    object: Identifier
...
class hasSpatialResolution(RdfProperty):
    term = RdfTerm('hasSpatialResolution', 'http://www.opengis.net/ont/geosparql#hasSpatialResolution', [])
    object: Identifier

@dataclass(frozen=True)
class hasSpatialAccuracy(RdfProperty):
    term = RdfTerm('hasSpatialAccuracy', 'http://www.opengis.net/ont/geosparql#hasSpatialAccuracy', [])
    object: Identifier
...
class sfIntersects(RdfProperty):
    term = RdfTerm('sfIntersects', 'http://www.opengis.net/ont/geosparql#sfIntersects', [])
    object: geo.SpatialObject
...
class coordinateDimension(RdfProperty):
    term = RdfTerm('coordinateDimension', 'http://www.opengis.net/ont/geosparql#coordinateDimension', [])
    object: Identifier
...
class hasSerialization(RdfProperty):
    term = RdfTerm('hasSerialization', 'http://www.opengis.net/ont/geosparql#hasSerialization', [])
    object: rdfs.Literal
...
class spatialDimension(RdfProperty):
    term = RdfTerm('spatialDimension', 'http://www.opengis.net/ont/geosparql#spatialDimension', [])
    object: Identifier

@dataclass(frozen=True)
class hasMetricSpatialResolution(RdfProperty):
    term = RdfTerm('hasMetricSpatialResolution', 'http://www.opengis.net/ont/geosparql#hasMetricSpatialResolution', [])
    object: Identifier

@dataclass(frozen=True)
class hasMetricSpatialAccuracy(RdfProperty):
    term = RdfTerm('hasMetricSpatialAccuracy', 'http://www.opengis.net/ont/geosparql#hasMetricSpatialAccuracy', [])
    object: Identifier

@dataclass(frozen=True)
class hasMetricLength(RdfProperty):
    term = RdfTerm('hasMetricLength', 'http://www.opengis.net/ont/geosparql#hasMetricLength', [])
    object: Identifier

@dataclass(frozen=True)
class hasMetricPerimeterLength(RdfProperty):
    term = RdfTerm('hasMetricPerimeterLength', 'http://www.opengis.net/ont/geosparql#hasMetricPerimeterLength', [])
    object: Identifier

@dataclass(frozen=True)
class hasMetricArea(RdfProperty):
    term = RdfTerm('hasMetricArea', 'http://www.opengis.net/ont/geosparql#hasMetricArea', [])
    object: Identifier

@dataclass(frozen=True)
class hasMetricVolume(RdfProperty):
    term = RdfTerm('hasMetricVolume', 'http://www.opengis.net/ont/geosparql#hasMetricVolume', [])
    object: Identifier

@dataclass(frozen=True)
class hasMetricSize(RdfProperty):
    term = RdfTerm('hasMetricSize', 'http://www.opengis.net/ont/geosparql#hasMetricSize', [])
    object: Identifier