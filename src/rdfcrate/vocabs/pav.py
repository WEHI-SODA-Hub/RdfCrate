...
class foafIsprimarytopicof(RdfProperty[RdfType]):
    term = RdfTerm('http://xmlns.com/foaf/0.1/isPrimaryTopicOf', 'foafIsprimarytopicof')

class foafName(RdfProperty[RdfType]):
    term = RdfTerm('http://xmlns.com/foaf/0.1/name', 'foafName')
...
class lastUpdatedOn(RdfProperty[RdfType]):
    term = RdfTerm('http://purl.org/pav/lastUpdateOn', 'lastUpdatedOn')
