...
class Cooperative(Organization):
    term = RdfTerm("Cooperative", "http://schema.org/Cooperative", [])
...
class lender(RdfProperty[schemaorg.Person | schemaorg.Organization]):
    term = RdfTerm(
...
class doorTime(RdfProperty[schemaorg.DateTime | schemaorg.Time]):
    term = RdfTerm(
...
class hiringOrganization(RdfProperty[schemaorg.Person | schemaorg.Organization]):
    term = RdfTerm(
        "hiringOrganization",
...
class numberOfCredits(RdfProperty[schemaorg.Integer | schemaorg.StructuredValue]):
    term = RdfTerm(
...
class temporalCoverage(
    RdfProperty[schemaorg.DateTime | schemaorg.Text | schemaorg.URL]
):
    term = RdfTerm(
        "temporalCoverage",
...
class missionCoveragePrioritiesPolicy(
    RdfProperty[schemaorg.URL | schemaorg.CreativeWork]
):
    term = RdfTerm(
...
class bccRecipient(
    RdfProperty[schemaorg.ContactPoint | schemaorg.Person | schemaorg.Organization]
):
    term = RdfTerm(
        "bccRecipient",
...
class bodyType(
    RdfProperty[schemaorg.Text | schemaorg.URL | schemaorg.QualitativeValue]
):
    term = RdfTerm(
...
class photos(RdfProperty[schemaorg.Photograph | schemaorg.ImageObject]):
    term = RdfTerm(
...
class members(RdfProperty[schemaorg.Person | schemaorg.Organization]):
    term = RdfTerm(
...
class endTime(RdfProperty[schemaorg.DateTime | schemaorg.Time]):
    term = RdfTerm(
...
class geoCrosses(RdfProperty[schemaorg.Place | schemaorg.GeospatialGeometry]):
    term = RdfTerm(
...
class pattern(RdfProperty[schemaorg.Text | schemaorg.DefinedTerm]):
...
class publicTransportClosuresInfo(RdfProperty[schemaorg.URL | schemaorg.WebContent]):
    term = RdfTerm(
...
class homeTeam(RdfProperty[schemaorg.SportsTeam | schemaorg.Person]):
    term = RdfTerm(
...
class version(RdfProperty[schemaorg.Text | schemaorg.Number]):
    term = RdfTerm(
...
class expires(RdfProperty[schemaorg.Date | schemaorg.DateTime]):
    term = RdfTerm(
...
class isBasedOnUrl(
    RdfProperty[schemaorg.URL | schemaorg.Product | schemaorg.CreativeWork]
):
    term = RdfTerm(
        "isBasedOnUrl",
...
class positiveNotes(
    RdfProperty[
        schemaorg.Text | schemaorg.ItemList | schemaorg.ListItem | schemaorg.WebContent
    ]
):
...
class inDefinedTermSet(RdfProperty[schemaorg.URL | schemaorg.DefinedTermSet]):
    term = RdfTerm(
        "inDefinedTermSet",
...
class founder(RdfProperty[schemaorg.Organization | schemaorg.Person]):
    term = RdfTerm(
...
class statType(RdfProperty[schemaorg.Property | schemaorg.Text | schemaorg.URL]):
...
class regionDrained(
    RdfProperty[schemaorg.AnatomicalSystem | schemaorg.AnatomicalStructure]
):
    term = RdfTerm(
        "regionDrained",
...
class broadcastSignalModulation(
    RdfProperty[schemaorg.Text | schemaorg.QualitativeValue]
):
    term = RdfTerm(
...
class recipeInstructions(
    RdfProperty[schemaorg.CreativeWork | schemaorg.Text | schemaorg.ItemList]
):
    term = RdfTerm(
        "recipeInstructions",
...
class repetitions(RdfProperty[schemaorg.Number | schemaorg.QuantitativeValue]):
    term = RdfTerm(
        "repetitions",
...
class normalRange(RdfProperty[schemaorg.MedicalEnumeration | schemaorg.Text]):
    term = RdfTerm(
        "normalRange",
...
class requiredCollateral(RdfProperty[schemaorg.Text | schemaorg.Thing]):
    term = RdfTerm(
        "requiredCollateral",
...
class numberOfRooms(RdfProperty[schemaorg.Number | schemaorg.QuantitativeValue]):
    term = RdfTerm(
        "numberOfRooms",
...
class artEdition(RdfProperty[schemaorg.Text | schemaorg.Integer]):
    term = RdfTerm(
...
class requirements(RdfProperty[schemaorg.Text | schemaorg.URL]):
    term = RdfTerm(
        "requirements",
...
class status(
    RdfProperty[
        schemaorg.Text | schemaorg.EventStatusType | schemaorg.MedicalStudyStatus
    ]
):
    term = RdfTerm(
...
class numberOfBedrooms(RdfProperty[schemaorg.QuantitativeValue | schemaorg.Number]):
    term = RdfTerm(
...
class sender(
    RdfProperty[schemaorg.Audience | schemaorg.Person | schemaorg.Organization]
):
    term = RdfTerm(
...
class extendedAddress(RdfProperty[schemaorg.Text]):
    term = RdfTerm("extendedAddress", "http://schema.org/extendedAddress", [])
...
class originalMediaLink(
    RdfProperty[schemaorg.MediaObject | schemaorg.URL | schemaorg.WebPage]
):
    term = RdfTerm(
...
class meetsEmissionStandard(
    RdfProperty[schemaorg.URL | schemaorg.QualitativeValue | schemaorg.Text]
):
    term = RdfTerm(
...
class availableLanguage(RdfProperty[schemaorg.Language | schemaorg.Text]):
    term = RdfTerm(
        "availableLanguage",
...
class reviewedBy(RdfProperty[schemaorg.Person | schemaorg.Organization]):
    term = RdfTerm(
...
class eligibleRegion(
    RdfProperty[schemaorg.Text | schemaorg.GeoShape | schemaorg.Place]
):
    term = RdfTerm(
        "eligibleRegion",
...
class totalPaymentDue(
    RdfProperty[schemaorg.MonetaryAmount | schemaorg.PriceSpecification]
):
    term = RdfTerm(
        "totalPaymentDue",
...
class acceptsReservations(
    RdfProperty[schemaorg.URL | schemaorg.Boolean | schemaorg.Text]
):
    term = RdfTerm(
        "acceptsReservations",
...
class genre(RdfProperty[schemaorg.URL | schemaorg.Text]):
    term = RdfTerm(
...
class gameAvailabilityType(
    RdfProperty[schemaorg.GameAvailabilityEnumeration | schemaorg.Text]
):
    term = RdfTerm(
...
class numberOfDoors(RdfProperty[schemaorg.Number | schemaorg.QuantitativeValue]):
    term = RdfTerm(
        "numberOfDoors",
...
class baseSalary(
    RdfProperty[
        schemaorg.MonetaryAmount | schemaorg.Number | schemaorg.PriceSpecification
    ]
):
    term = RdfTerm(
...
class driveWheelConfiguration(
    RdfProperty[schemaorg.Text | schemaorg.DriveWheelConfigurationValue]
):
    term = RdfTerm(
...
class hasMenu(RdfProperty[schemaorg.URL | schemaorg.Menu | schemaorg.Text]):
    term = RdfTerm(
...
class video(RdfProperty[schemaorg.VideoObject | schemaorg.Clip]):
    term = RdfTerm(
...
class educationalCredentialAwarded(
    RdfProperty[
        schemaorg.Text | schemaorg.URL | schemaorg.EducationalOccupationalCredential
    ]
):
    term = RdfTerm(
...
class dataFeedElement(
    RdfProperty[schemaorg.Text | schemaorg.Thing | schemaorg.DataFeedItem]
):
    term = RdfTerm(
        "dataFeedElement",
...
class diseaseSpreadStatistics(
    RdfProperty[
        schemaorg.Observation | schemaorg.Dataset | schemaorg.URL | schemaorg.WebContent
    ]
):
    term = RdfTerm(
...
class priceType(RdfProperty[schemaorg.Text | schemaorg.PriceTypeEnumeration]):
    term = RdfTerm(
...
class preparation(RdfProperty[schemaorg.MedicalEntity | schemaorg.Text]):
    term = RdfTerm(
        "preparation",
...
class variesBy(RdfProperty[schemaorg.DefinedTerm | schemaorg.Text]):
...
class screenshot(RdfProperty[schemaorg.ImageObject | schemaorg.URL]):
    term = RdfTerm(
...
class correction(
    RdfProperty[schemaorg.Text | schemaorg.CorrectionComment | schemaorg.URL]
):
    term = RdfTerm(
...
class isVariantOf(RdfProperty[schemaorg.ProductGroup | schemaorg.ProductModel]):
    term = RdfTerm(
        "isVariantOf",
...
class assesses(RdfProperty[schemaorg.DefinedTerm | schemaorg.Text]):
...
class knowsLanguage(RdfProperty[schemaorg.Language | schemaorg.Text]):
    term = RdfTerm(
...
class backstory(RdfProperty[schemaorg.CreativeWork | schemaorg.Text]):
    term = RdfTerm(
...
class artMedium(RdfProperty[schemaorg.URL | schemaorg.Text]):
    term = RdfTerm(
...
class steps(RdfProperty[schemaorg.ItemList | schemaorg.CreativeWork | schemaorg.Text]):
    term = RdfTerm(
...
class availabilityEnds(
    RdfProperty[schemaorg.Time | schemaorg.Date | schemaorg.DateTime]
):
    term = RdfTerm(
        "availabilityEnds",
...
class supersededBy(
    RdfProperty[schemaorg.Property | schemaorg.Enumeration | schemaorg.Class]
):
    term = RdfTerm(
        "supersededBy",
...
class speakable(RdfProperty[schemaorg.URL | schemaorg.SpeakableSpecification]):
    term = RdfTerm(
...
class byArtist(RdfProperty[schemaorg.Person | schemaorg.MusicGroup]):
    term = RdfTerm(
...
class serviceArea(
    RdfProperty[schemaorg.GeoShape | schemaorg.Place | schemaorg.AdministrativeArea]
):
    term = RdfTerm(
        "serviceArea",
...
class legislationPassedBy(RdfProperty[schemaorg.Person | schemaorg.Organization]):
    term = RdfTerm(
        "legislationPassedBy",
...
class orderQuantity(RdfProperty[schemaorg.QuantitativeValue | schemaorg.Number]):
    term = RdfTerm(
        "orderQuantity",
...
class sizeSystem(RdfProperty[schemaorg.SizeSystemEnumeration | schemaorg.Text]):
    term = RdfTerm("sizeSystem", "http://schema.org/sizeSystem", ["1.2-DRAFT"])


class paymentStatus(RdfProperty[schemaorg.Text | schemaorg.PaymentStatusType]):
    term = RdfTerm(
        "paymentStatus",
...
class monthlyMinimumRepaymentAmount(
    RdfProperty[schemaorg.MonetaryAmount | schemaorg.Number]
):
    term = RdfTerm(
...
class isSimilarTo(RdfProperty[schemaorg.Service | schemaorg.Product]):
    term = RdfTerm(
        "isSimilarTo",
...
class width(RdfProperty[schemaorg.QuantitativeValue | schemaorg.Distance]):
    term = RdfTerm(
...
class ownershipFundingInfo(
    RdfProperty[
        schemaorg.Text | schemaorg.AboutPage | schemaorg.URL | schemaorg.CreativeWork
    ]
):
    term = RdfTerm(
...
class bestRating(RdfProperty[schemaorg.Text | schemaorg.Number]):
    term = RdfTerm(
...
class taxonomicRange(
    RdfProperty[
        schemaorg.Taxon | schemaorg.Text | schemaorg.DefinedTerm | schemaorg.URL
    ]
):
...
class negativeNotes(
    RdfProperty[
        schemaorg.ListItem | schemaorg.WebContent | schemaorg.Text | schemaorg.ItemList
    ]
):
...
class namedPosition(RdfProperty[schemaorg.Text | schemaorg.URL]):
    term = RdfTerm(
        "namedPosition",
...
class inLanguage(RdfProperty[schemaorg.Language | schemaorg.Text]):
    term = RdfTerm(
...
class usesHealthPlanIdStandard(RdfProperty[schemaorg.Text | schemaorg.URL]):
    term = RdfTerm(
...
class height(RdfProperty[schemaorg.QuantitativeValue | schemaorg.Distance]):
    term = RdfTerm(
...
class coursePrerequisites(
    RdfProperty[schemaorg.AlignmentObject | schemaorg.Text | schemaorg.Course]
):
    term = RdfTerm(
        "coursePrerequisites",
...
class legislationResponsible(RdfProperty[schemaorg.Person | schemaorg.Organization]):
    term = RdfTerm(
...
class gamePlatform(RdfProperty[schemaorg.Text | schemaorg.Thing | schemaorg.URL]):
    term = RdfTerm(
        "gamePlatform",
...
class availableService(
    RdfProperty[
        schemaorg.MedicalTherapy | schemaorg.MedicalProcedure | schemaorg.MedicalTest
    ]
):
    term = RdfTerm(
        "availableService",
...
class merchantReturnDays(
    RdfProperty[schemaorg.Integer | schemaorg.Date | schemaorg.DateTime]
):
    term = RdfTerm(
        "merchantReturnDays",
...
class supply(RdfProperty[schemaorg.Text | schemaorg.HowToSupply]):
    term = RdfTerm(
...
class homeLocation(RdfProperty[schemaorg.Place | schemaorg.ContactPoint]):
    term = RdfTerm(
        "homeLocation",
...
class downPayment(RdfProperty[schemaorg.MonetaryAmount | schemaorg.Number]):
    term = RdfTerm(
        "downPayment",
...
class price(RdfProperty[schemaorg.Number | schemaorg.Text]):
    term = RdfTerm(
...
class legislationCountersignedBy(
    RdfProperty[schemaorg.Person | schemaorg.Organization]
):
    term = RdfTerm(
...
class roleName(RdfProperty[schemaorg.URL | schemaorg.Text]):
    term = RdfTerm(
...
class publisher(RdfProperty[schemaorg.Person | schemaorg.Organization]):
    term = RdfTerm(
...
class experienceRequirements(
    RdfProperty[schemaorg.Text | schemaorg.OccupationalExperienceRequirements]
):
    term = RdfTerm(
...
class photo(RdfProperty[schemaorg.Photograph | schemaorg.ImageObject]):
    term = RdfTerm(
...
class volumeNumber(RdfProperty[schemaorg.Text | schemaorg.Integer]):
    term = RdfTerm(
        "volumeNumber",
...
class geoIntersects(RdfProperty[schemaorg.Place | schemaorg.GeospatialGeometry]):
    term = RdfTerm(
...
class arrivalTime(RdfProperty[schemaorg.DateTime | schemaorg.Time]):
    term = RdfTerm(
        "arrivalTime",
...
class afterMedia(RdfProperty[schemaorg.URL | schemaorg.MediaObject]):
    term = RdfTerm(
...
class hasMap(RdfProperty[schemaorg.Map | schemaorg.URL]):
    term = RdfTerm(
...
class storageRequirements(RdfProperty[schemaorg.URL | schemaorg.Text]):
    term = RdfTerm(
        "storageRequirements",
...
class material(RdfProperty[schemaorg.URL | schemaorg.Product | schemaorg.Text]):
    term = RdfTerm(
...
class tool(RdfProperty[schemaorg.Text | schemaorg.HowToTool]):
...
class beforeMedia(RdfProperty[schemaorg.URL | schemaorg.MediaObject]):
    term = RdfTerm(
        "beforeMedia",
...
class typeOfGood(RdfProperty[schemaorg.Service | schemaorg.Product]):
    term = RdfTerm(
...
class mathExpression(RdfProperty[schemaorg.Text | schemaorg.SolveMathAction]):
...
class followee(RdfProperty[schemaorg.Organization | schemaorg.Person]):
    term = RdfTerm(
...
class audio(
    RdfProperty[schemaorg.Clip | schemaorg.AudioObject | schemaorg.MusicRecording]
):
    term = RdfTerm(
...
class vendor(RdfProperty[schemaorg.Organization | schemaorg.Person]):
    term = RdfTerm(
...
class fileFormat(RdfProperty[schemaorg.URL | schemaorg.Text]):
    term = RdfTerm(
        "fileFormat", "http://schema.org/fileFormat", ["0.2", "1.0", "1.1", "1.2-DRAFT"]
    )


class actionOption(RdfProperty[schemaorg.Text | schemaorg.Thing]):
    term = RdfTerm(
        "actionOption",
...
class orderedItem(
    RdfProperty[schemaorg.Service | schemaorg.Product | schemaorg.OrderItem]
):
    term = RdfTerm(
        "orderedItem",
...
class costPerUnit(
    RdfProperty[schemaorg.Text | schemaorg.Number | schemaorg.QualitativeValue]
):
    term = RdfTerm(
        "costPerUnit",
...
class billingDuration(
    RdfProperty[schemaorg.Number | schemaorg.QuantitativeValue | schemaorg.Duration]
):
    term = RdfTerm(
...
class actionPlatform(
    RdfProperty[schemaorg.URL | schemaorg.Text | schemaorg.DigitalPlatformEnumeration]
):
    term = RdfTerm(
        "actionPlatform",
...
class artform(RdfProperty[schemaorg.URL | schemaorg.Text]):
    term = RdfTerm(
...
class businessDays(
    RdfProperty[schemaorg.OpeningHoursSpecification | schemaorg.DayOfWeek]
):
    term = RdfTerm(
...
class petsAllowed(RdfProperty[schemaorg.Text | schemaorg.Boolean]):
    term = RdfTerm(
        "petsAllowed",
...
class occupationalCategory(RdfProperty[schemaorg.Text | schemaorg.CategoryCode]):
    term = RdfTerm(
...
class prescriptionStatus(
    RdfProperty[schemaorg.DrugPrescriptionStatus | schemaorg.Text]
):
    term = RdfTerm(
        "prescriptionStatus",
...
class announcementLocation(
    RdfProperty[schemaorg.CivicStructure | schemaorg.LocalBusiness]
):
    term = RdfTerm(
...
class referee(RdfProperty[schemaorg.Person]):
    term = RdfTerm("referee", "http://schema.org/referee", [])
...
class orderDate(RdfProperty[schemaorg.Date | schemaorg.DateTime]):
    term = RdfTerm(
...
class itemListElement(
    RdfProperty[schemaorg.Text | schemaorg.Thing | schemaorg.ListItem]
):
    term = RdfTerm(
        "itemListElement",
...
class identifier(RdfProperty[schemaorg.Text | schemaorg.URL | schemaorg.PropertyValue]):
    term = RdfTerm(
...
class spokenByCharacter(RdfProperty[schemaorg.Person | schemaorg.Organization]):
    term = RdfTerm(
        "spokenByCharacter",
