...
class fundedItem(RdfProperty):
    ...
    object: schemaorg.Product | schemaorg.Person | schemaorg.MedicalEntity | schemaorg.BioChemEntity | schemaorg.Organization | schemaorg.Event | schemaorg.CreativeWork
...
class valueReference(RdfProperty):
    ...
    object: Text | schemaorg.PropertyValue | schemaorg.MeasurementTypeEnumeration | schemaorg.DefinedTerm | schemaorg.QuantitativeValue | schemaorg.Enumeration | schemaorg.StructuredValue | schemaorg.QualitativeValue
...
class associatedAnatomy(RdfProperty):
    ...
    object: schemaorg.SuperficialAnatomy | schemaorg.AnatomicalStructure | schemaorg.AnatomicalSystem
...
class grantee(RdfProperty):
    ...
    object: schemaorg.Audience | schemaorg.ContactPoint | schemaorg.Person | schemaorg.Organization
...
class programPrerequisites(RdfProperty):
    ...
    object: schemaorg.EducationalOccupationalCredential | schemaorg.AlignmentObject | Text | schemaorg.Course
...
class hasTierRequirement(RdfProperty):
    ...
    object: Text | schemaorg.MonetaryAmount | schemaorg.CreditCard | schemaorg.UnitPriceSpecification
...
class category(RdfProperty):
    ...
    object: schemaorg.CategoryCode | URL | schemaorg.Thing | schemaorg.PhysicalActivityCategory | Text
...
class recipient(RdfProperty):
    ...
    object: schemaorg.Organization | schemaorg.Audience | schemaorg.ContactPoint | schemaorg.Person
...
class size(RdfProperty):
    ...
    object: schemaorg.QuantitativeValue | schemaorg.DefinedTerm | schemaorg.SizeSpecification | Text
...
class memberOf(RdfProperty):
    ...
    object: schemaorg.Organization | schemaorg.ProgramMembership | schemaorg.MemberProgramTier
...
class expressedIn(RdfProperty):
    ...
    object: schemaorg.AnatomicalStructure | schemaorg.BioChemEntity | schemaorg.DefinedTerm | schemaorg.AnatomicalSystem
...
class itemOffered(RdfProperty):
    ...
    object: schemaorg.Trip | schemaorg.Product | schemaorg.AggregateOffer | schemaorg.MenuItem | schemaorg.Service | schemaorg.Event | schemaorg.CreativeWork
...
class variableMeasured(RdfProperty):
    ...
    object: schemaorg.Property | schemaorg.StatisticalVariable | schemaorg.PropertyValue | Text
